...
def main() -> None:
    ...
    parser.add_argument("--source-images", type=Path, required=True, help="Path to source images directory.")
    parser.add_argument("--source-labels", type=Path, required=True, help="Path to source labels directory.")
    parser.add_argument(
        "--dest-base",
        type=Path,
        required=True,
    ...
    print(f"Dataset split completed successfully! train={n_train}, val={n_val}, test={n_test}")
